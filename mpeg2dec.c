...
/*
  ...
  */
    ...
    if(frameFinished)
    {
        ...
        {
            frame_delay = (1/ av_q2d(is->video_st->avg_frame_rate) ) /* * is->video_st->codec->ticks_per_frame */ ;
        }
        else
        {
           frame_delay = av_q2d(is->AVCodecContext->time_base) * is->AVCodecContext->ticks_per_frame ;
        }
