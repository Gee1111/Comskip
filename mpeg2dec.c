...
/*
  ...
  */
    ...
    if(frameFinished)
    {
        ...
        if(is->video_st->AVStream->avg_frame_rate.den && is->video_st->AVStream->avg_frame_rate.num)
        {
            frame_delay = (1/ av_q2d(is->video_st->AVStream->avg_frame_rate) ) /* * is->video_st->codec->ticks_per_frame */ ;
        }
        else
        {
